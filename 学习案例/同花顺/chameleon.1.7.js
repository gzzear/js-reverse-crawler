...
window = global;
window.addEventListener = function (callback) {
    console.log("window::addEventListener::", callback);
};
...
proxyObjs = ['window', 'document', 'location', 'navigator', 'history', 'screen', '_head', '_documentElement']
SetProxy(proxyObjs)

var TOKEN_SERVER_TIME = 1758543001.110;
!function(n, t, r, e) {
    !function() {
        var a = r[0]
          , u = n[0]
