window = (function(){
  ...
  Object.defineProperties(Node.prototype, {
    ...
    baseURI: {"enumerable":true,"configurable":true,"get":function(){return "https://careers.pddglobalhr.com/jobs"},"set":function(){return true}},
  ...
  Object.defineProperties(Document.prototype, {
    URL: {"enumerable":true,"configurable":true,"get":function(){return "https://careers.pddglobalhr.com/jobs"},"set":function(){return true}},
    documentURI: {"enumerable":true,"configurable":true,"get":function(){return "https://careers.pddglobalhr.com/jobs"},"set":function(){return true}},
    ...
    domain: {"enumerable":true,"configurable":true,"get":function(){return "careers.pddglobalhr.com"},"set":function(){return true}},
    referrer: {"enumerable":true,"configurable":true,"get":function(){return ""},"set":function(){return true}},
    lastModified: {"enumerable":true,"configurable":true,"get":function(){return "01/09/2026 21:01:50"},"set":function(){return true}},
    readyState: {"enumerable":true,"configurable":true,"get":function(){return "complete"},"set":function(){return true}},
    title: {"enumerable":true,"configurable":true,"get":function(){return "拼多多集团-PDD社会招聘"},"set":function(){return true}},
  ...
  Object.defineProperties(Performance.prototype, {
    timeOrigin: {"enumerable":true,"configurable":true,"get":function(){return 1767963649081.7},"set":function(){return true}},
  ...
  function v_init_event_target(){
    ...
    function add_event(_this, x){
      ...
      if (typeof listener === 'function') {
          // 如果是普通函数，bind 这里的 this 指向目标元素
          callback = listener.bind(_this);
      } else if (listener && typeof listener === 'object' && typeof listener.handleEvent === 'function') {
          // 如果是对象（实现了 handleEvent 接口），bind 这里的 this 必须指向对象本身，否则脚本逻辑会出错
          callback = listener.handleEvent.bind(listener);
      } else {
          // 兜底，防止传入 null 或 undefined 报错
          callback = function() {};
      }

      v_events[x[0]].push([_this, callback])
      // ----------- 修复结束 -----------
    }
  ...
  init_cookie("_nano_fp=XpmjnqmJlpPqn0gJlT_xPuMAd05G886HW1A49bJm")
  v_hook_href(window.location, 'location', "https://careers.pddglobalhr.com/jobs")
  Location.prototype.toString = v_saf(function toString(){ return "https://careers.pddglobalhr.com/jobs" })
...
// ----------------- History Start -----------------
  ...
  // 定义 History 原型上的属性 (getter/setter)
  Object.defineProperties(History.prototype, {
    length: { enumerable: true, configurable: true, get: v_saf(function(){ return 1 }, "length") },
    scrollRestoration: { enumerable: true, configurable: true, get: v_saf(function(){ return "auto" }, "scrollRestoration"), set: function(){ return true } },
    state: { enumerable: true, configurable: true, get: v_saf(function(){ return null }, "state") },
    [Symbol.toStringTag]: { value: "History", writable: false, enumerable: false, configurable: true },
  });

  // 定义 History 原型上的方法
  History.prototype.back = v_saf(function back() { v_console_log("  [*] History -> back[func]") }, "back");
  History.prototype.forward = v_saf(function forward() { v_console_log("  [*] History -> forward[func]") }, "forward");
  History.prototype.go = v_saf(function go() { v_console_log("  [*] History -> go[func]", arguments) }, "go");
  History.prototype.pushState = v_saf(function pushState(data, title, url) {
    v_console_log("  [*] History -> pushState[func]", data, title, url);
    // 如果需要模拟 url 变化，可以在这里修改 window.location.href
  }, "pushState");
  History.prototype.replaceState = v_saf(function replaceState(data, title, url) {
    v_console_log("  [*] History -> replaceState[func]", data, title, url)
  }, "replaceState");
