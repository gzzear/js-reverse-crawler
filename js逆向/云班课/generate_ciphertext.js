...
* @returns {Password}
*/
__exports.encrypt_password = function(phone, password) {
    const ptr0 = passStringToWasm0(phone, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(password, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.encrypt_password(ptr0, len0, ptr1, len1);
    return Password.__wrap(ret);
};
window.encrypt_password = __exports.encrypt_password;
...
class Password {
    ...
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(Password.prototype);
        obj.__wbg_ptr = ptr;
    ...
    */
    static new(ciphertext) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.password_new(ptr0, len0);
        return Password.__wrap(ret);
    }
    /**
    * @returns {string}
    */
    ciphertext() {
        ...
        try {
            ...
            wasm.password_ciphertext(retptr, this.__wbg_ptr);
...
await wasm_bindgen('https://static-cdn-oss.mosoteach.cn/third-party/wasm/1.0.0/no-modules/encrypt_bg.wasm')
const result = window.encrypt_password("19113189219", "11111")
