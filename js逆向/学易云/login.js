//http://passport.xueyiyun.com/login.html
...
const rsaPublicKey = {
    "dwKeySize": 2048,
    "exponent": "010001",
    "modulus": ""
}

function encrypt(str) {
    setMaxDigits(262);
    var key = new RSAKeyPair(rsaPublicKey.exponent, "", rsaPublicKey.modulus, parseInt(rsaPublicKey.dwKeySize));
    var ciphertext = encryptedString(key, str, RSAAPP.PKCS1Padding, RSAAPP.RawEncoding);
    str = a(ciphertext);
    return encodeURIComponent(str);
}

console.log(encrypt("gaozhe741234"));